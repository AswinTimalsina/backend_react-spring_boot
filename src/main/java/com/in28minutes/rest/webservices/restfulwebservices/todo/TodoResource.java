...
public class TodoResource {
	...
	public ResponseEntity<Void> deleteTodo(@PathVariable String username, @PathVariable long id){
		...
		if(todo!= null) {
			return ResponseEntity.noContent().build(); //no content for successfully deleted
		}
		return ResponseEntity.notFound().build(); //if not deleted not found status returned
	}
}
